...
//     tracker->makeTrackPointsbyFrame(frame);
...
*/
 ...
 //   int FrameTrace = 0;  // debug depth recovery algorithm
    ...
    for(int j = Index; j <= Index+FrameSize; j++)
    {
...
/*
        for(int lvl = 0; lvl < tracker->MInfOptiInfo.size(); lvl++)
        {
            cout << tracker->MInfOptiInfo[lvl].MuInfo << "  ";
        }
        cout << endl;
*/
...
/*
        ...
        {
            cout << tracker->CalcRefMInfo(lvl, refToNew) << "  ";
        }
        cout << endl;
*/
        if(flag1)
...
/*
        ...
        for(int lvl = 0; lvl < tracker->MInfOptiInfo.size(); lvl++)
        {
            cout << tracker->MInfOptiInfo[lvl].acceptedIterations << "  ";
        }
        cout << endl;
*/
        ...
        if(!(flag1 || flag2))  refToNew_MI = refToNew_backup;
...

        {
            ...
            cout << "flag1=" << flag1 << ", " << "flag2=" << false << endl;
